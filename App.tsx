...
const WhatsAppButton: React.FC = () => (
  <a 
    ...
    className="fixed bottom-8 left-8 z-40 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center group"
  >
    ...
    <span className="absolute left-full ml-4 bg-[#2C3468] text-white px-3 py-1 rounded text-[10px] font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl">
      CONCIERGE
    </span>
  </a>
);
